...
//include 'header.php';
 ...
 Na podstawie stworzonych punktacji do ankiet (konkursów), możesz wyznaczyć ranking studentów,usuwać konkursy oraz wysyłać wiadomości do admina. 
        ...
        if ($result->num_rows > 0) {
           echo '<div class="row" style="margin: auto; width: 100%; ">
            <div class="defaultDiv" style="text-align: center; width: 30%;height:100%;">
            <b class="defaultFont" style="font-weight:700;"> Tworzenie listy studentów </b>
            <form method="post" action="istniejace_konkursy_pracodawca.php" style="text-align: center;width:100%;">';
            ...
            echo '<input type="number" class="form-control" min="1" max="50" id="ilosc_osob" name="ilosc_osob" required><br/>';
            echo '<input type="submit" class="btn btn-primary" style="width: 80%; margin-bottom:2%;" value="Stwórz">';
            echo '</form>';
            echo "</div>";
        }
        }
        ...
        /*     echo '<div class="row" style="margin-top: 20px; margin-bottom: 20px;"> */
                   echo' <div class="defaultDiv" style=" text-align: center; width: 30%; height:100%;">
                    <b class="defaultFont">Utwórz/edytuj konkurs</b>';
            //echo '<br>';
            echo '<form method="post" action="formularz_pracodawca.php" style="text-align: center; width:100%;">';
            ...
            echo '<input type="text" class="form-control" id="nazwa_konkursu" name="nazwa_konkursu" required><br/>';
            echo '<input type="submit" class="btn btn-primary" style="width: 80%; margin-bottom:2%" value="Zatwierdź">';
            echo '</form>';
            echo '</div>';
        }
        ...
        $result = $conn->query($sql_konkursy);
        if ($result->num_rows > 0) {
            echo '<div class="defaultDiv" style="width: 30%; text-align:center;height:100%;">
            <b class="defaultFont"> Usuń konkurs</b></br>
            <form method="post" action="usun_konkurs_pracodawca.php" style="text-align: center; width;100%;">';
            ...
            echo '<input type="submit" class="btn btn-primary" style="width: 80%; margin-bottom:5%; ;" value="Usuń">';
            echo '</form></div>';
        }
     
//                  SUGESTIE
                    echo '<div class="defaultDiv defaultFont" style="margin-top: 20px; margin-bottom: 20px;width: 30%; height:100%;">
                        ...
                        <textarea name="sugestia" id="sugestia" rows="4" cols="40" maxlength="100" style="width:100%;"></textarea>
                        <input type="submit" class="btn btn-primary" style="width: 80%; margin-bottom:2%" value="Wyślij">
                        </form>
                        </div>';
